...
/**
 * Sete blocos. Prótese removível, pouco osso e medo de operar são objeções
 * sobre as ETAPAS, então continuam na seção de decisão, imediatamente depois
 * do critério que as responde, e a trilha mostra a sequência logo abaixo.
 *
